...
public final class Deck {
    ...
    /**
     * Puts the given card to the random position of the deck, which will be generated by the given
     * {@code RandomProvider}.
     *
    ...
    /**
     * Tries to draw a random card with the given {@code RandomProvider} from the remaining cards which
