...
public final class SilenceTest {
    ...
    public void testSilenceAuraGiver() {
        PlayScript.testScript((script) -> {
            ...
            script.playNonMinionCard("p2", SILENCE, "p1:2");
    ...
    public void testSilenceRemovesSpellDamage() {
        PlayScript.testScript((script) -> {
            ...
            script.playNonMinionCard("p1", SILENCE, "p1:0");
            script.playNonMinionCard("p1", MOONFIRE, "p1:1");
    ...
    public void testCannotSilenceAuraBuffs() {
        PlayScript.testScript((script) -> {
            ...
            script.playNonMinionCard("p2", SILENCE, "p1:0");
            expectTestStormwindBoard(script);

            script.playNonMinionCard("p2", SILENCE, "p1:1");
            expectTestStormwindBoard(script);

            script.playNonMinionCard("p2", SILENCE, "p1:3");
            expectTestStormwindBoard(script);

            script.playNonMinionCard("p2", SILENCE, "p1:4");
            expectTestStormwindBoard(script);
        });
    }
    ...
    public void testSilenceDeathRattle() {
        PlayScript.testScript((script) -> {
            ...
            script.setMana("p1", 10);
            script.playNonMinionCard("p1", PYROBLAST, "p1:0");
