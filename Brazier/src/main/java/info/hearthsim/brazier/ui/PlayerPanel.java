...
public class PlayerPanel extends javax.swing.JPanel {
    ...
    public void setState(PlayerUiAgent uiAgent, Player player) {
        ...
        int charges = weapon != null ? weapon.getDurability() : 1;
        ...
        jDeckSizeValueLabel.setText(Integer.toString(player.getDeck().getNumberOfCards()));
        ...
        String heroPowerName = heroPower.getPowerDef().getName();
        jUsePowerButton.setText(heroPowerName.isEmpty() ? "Use power" : heroPowerName);
        jUsePowerButton.setVisible(uiAgent != null);
        jUsePowerButton.setEnabled(player.getHero().getHeroPower().isPlayable());
