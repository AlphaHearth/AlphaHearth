...
/**
 * Predefined {@link WorldEventFilter}s.
 */
public final class WorldEventFilters {
    ...
    public static final WorldEventFilter<PlayerProperty, AttackRequest> ATTACK_TARGET_IS_MINION
            = (world, owner, eventSource) -> eventSource.testExistingTarget((defender) -> defender instanceof Minion);
    ...
    public static final WorldEventFilter<PlayerProperty, AttackRequest> ATTACK_TARGET_IS_OWNER
            = (world, owner, eventSource) -> eventSource.testExistingTarget((defender) -> owner.getOwner() == defender.getOwner());
    ...
    public static WorldEventFilter<Object, Object> minionDiedWithKeyword(
        ...
        return (World world, Object owner, Object eventSource) -> {
            return world.getPlayer1().getGraveyard().hasWithKeyword(keywordsCopy)
                    || world.getPlayer2().getGraveyard().hasWithKeyword(keywordsCopy);
        };
    }
